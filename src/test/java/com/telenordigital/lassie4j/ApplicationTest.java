...
import com.telenordigital.lassie4j.entities.ImmutableApplication;
...
public class ApplicationTest {
    ...
    public void testApplication() throws Exception {
        ...
        final Application n = new ImmutableApplication.Builder().tags(tags).build();
        final Application app = client.createApplication(n);
